...
requires "nim >= 2.2.0",
          ...
          # against (0.5.5/0.5.6 were tagged after the cluster runs). A capped range,
          # not a URL pin: nimble re-resolves URL-pinned deps at compile time and
          # re-clones over the tick-floor patch, shipping a stock quic stack.
          "lsquic >= 0.5.4 & < 0.5.5",
          "ggplotnim"